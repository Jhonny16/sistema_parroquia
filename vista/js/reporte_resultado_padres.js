...
function listado(){
    ...
    $.ajax({
        data: data,
        url: "../controlador/reporte_caja_padres.php",
        type: "post",
        success: function (resultado) {
            ...
            if (datosJSON.estado === 200) {
                ...
                html += '<table id="table_ingresos" class="table table-bordered table-hover">' +
                    '<thead>' +
                    '<tr><th style="font-style: oblique;color: #01a189" colspan="15">Limosnas por padre año ' + $("#busqueda_anio").val() + ' : </th></tr>'+
                    '<tr style="background-color: #01a189; color: white">' +
                    '<th  style="text-align: center; background-color: #005b80">#.</th>' +
                    '<th style="background-color: #005b80">Padre</th>' +
                    '<th>Enero</th>' +
                    '<th>Febrero</th>' +
                    '<th>Marzo</th>' +
                    '<th>Abril</th>' +
                ...
                $.each(ingresos, function (i, item) {
                    ...
                    html += '<td style="background-color: #e3e3e3">' + item.padre + '</td>';
                ...
                html += '</tfoot>';
                html += '</table>';
                $("#lista_limosnas").html(html);

                var html2 = "";
                html2 += '<table id="table_egresos" class="table table-bordered table-hover">' +
                    '<thead>' +
                    '<tr><th style="font-style: oblique;color: #01a189" colspan="15">Misas por padre año ' + $("#busqueda_anio").val() + ' : </th></tr>'+
                    '<tr style="background-color: #01a189; color: white">' +
                    '<th  style="text-align: center; background-color: #005b80">#.</th>' +
                    '<th style="background-color: #005b80">Padre</th>' +
                    '<th>Enero</th>' +
                ...
                $.each(egresos, function (i, item) {
                    ...
                    html2 += '<td style="background-color: #e3e3e3">' + item.padre + '</td>';
                    ...
                    html2 += '<td style="text-align: right;background-color: #ececec">' + total + '</td>';
                    html2 += '</tr>';
                ...
                html2 += '<th style="text-align: right"> '+ enero_e +'</th>';
                html2 += '<th style="text-align: right"> '+ febrero_e +'</th>';
                html2 += '<th style="text-align: right"> '+ marzo_e +'</th>';
                html2 += '<th style="text-align: right"> '+ abril_e +'</th>';
                html2 += '<th style="text-align: right"> '+ mayo_e +'</th>';
                html2 += '<th style="text-align: right"> '+ junio_e +'</th>';
                html2 += '<th style="text-align: right"> '+ julio_e +'</th>';
                html2 += '<th style="text-align: right"> '+ agosto_e +'</th>';
                html2 += '<th style="text-align: right"> '+ setiembre_e +'</th>';
                html2 += '<th style="text-align: right"> '+ octubre_e +'</th>';
                html2 += '<th style="text-align: right"> '+ noviembre_e +'</th>';
                html2 += '<th style="text-align: right"> '+ diciembre_e +'</th>';
                html2 += '<th style="text-align: right"> '+ suma_e +'</th>';
                html2 += '</tr>';
                html2 += '</tfoot>';
                html2 += '</table>';
                $("#lista_misas").html(html2);


            } else {
                $("#lista_limosnas").empty();
                $("#lista_misas").empty();
