...
<html>
<head>
    <title>Reporte utilidades misa comunitaria</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-md-12 col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <select id="busqueda_secretario_id" name="busqueda_secretario_id" class="form-control">
                                            </select>
                                        </div>
                                    </div>
                                      <div class="col-xs-12 col-md-12 col-lg-3">
...
<!--                                        </button>-->
                                        <hr>
                                        <div id="lista_misas_comunitarias_utilidades"></div>
                                    </div>
...
<script src="js/reporte_misa_comunitaria_utilidades.js" type="text/javascript"></script>
