...
<html>
    <head>
        <title>Mantenimiento de Horario Patron</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper" style="background-color: white" >
                ...
                <section class="content-header">
                    <h1>
                        Mantenimiento de Horario Patron
                    </h1>
                    <ol class="breadcrumb">
                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal" id="btnagregar"><i class="fa fa-copy"></i> Agregar Horario</button>&nbsp;&nbsp;&nbsp;
                        <li><a href="#"><i class="fa fa-dashboard"></i> Menú Principal</a></li>
                        <li><a href="#">Mantenimientos</a></li>
                        <li class="active">Mantenimiento de Horario Patron</li>
                    </ol>
                </section>
        ...
        <script src="js/mantenimiento.horarioPatron.js" type="text/javascript"></script>
