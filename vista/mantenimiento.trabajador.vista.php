        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal"
                        id="btnagregar"><i class="fa fa-copy"></i> Agregar Trabajador
                </button>&nbsp;&nbsp;&nbsp;
                <li><a href="#"><i class="fa fa-dashboard"></i> Menú Principal</a></li>
                <li><a href="#">Mantenimientos</a></li>
                <li class="active">Mantenimiento de Trabajador</li>
            </ol>
        </section>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-xs-3">
                                            <p>
                                                <input type="" value="" id="txtTipoOperacion" name="txtTipoOperacion"
                                                       style="display: none">
...
<script src="js/cargar.combos.trabajador.cargo.js" type="text/javascript"></script>
<script src="js/cargar.combos.trabajador.ocup.js" type="text/javascript"></script>
<script src="js/mantenimiento.trabajador.js" type="text/javascript"></script>
