...
<html>
    <head>
        <title>Mantenimiento de Ocupación</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper" style="background-color: white" >
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal" id="btnagregar"><i class="fa fa-copy"></i> Agregar Ocupación</button>&nbsp;&nbsp;&nbsp;
                        <li><a href="#"><i class="fa fa-dashboard"></i> Menú Principal</a></li>
                        <li><a href="#">Mantenimientos</a></li>
                        <li class="active">Mantenimiento de Ocupación</li>
                    </ol>
                </section>
                                                ...
                                                <div class="col-xs-12">
                                                    <p>
                                                        Nombre de la Ocupación 
                                                               <input type="text" 
                                                                      name="txtNombreOcupacion" 
                                                                      id="txtNombreOcupacion" 
        ...
        <script src="js/mantenimiento.ocupacion.js" type="text/javascript"></script>
