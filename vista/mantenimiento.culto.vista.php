...
<html>
    <head>
        <title>Mantenimiento de Culto</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper" style="background-color: white" >
                ...
                <section class="content-header">
                    <h1>
                        Mantenimiento de Culto
                    </h1>
                    <ol class="breadcrumb">
                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal" id="btnagregar"><i class="fa fa-copy"></i> Agregar Culto</button>&nbsp;&nbsp;&nbsp;
                        <li><a href="#"><i class="fa fa-dashboard"></i> Menú Principal</a></li>
                        <li><a href="#">Mantenimientos</a></li>
                        <li class="active">Mantenimiento de Culto</li>
                    </ol>
                </section>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <p>
                                                        Celebración
                                                        <select name="cboCategoria" id="cboCategoria" class="form-control input-sm" required="">
        ...
        <script src="js/mantenimiento.culto.js" type="text/javascript"></script>
