...
<html>
    <head>
        <title>Mantenimiento de Celebracion</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper" style="background-color: white" >
                ...
                <section class="content-header">
                    <h1>
                        Mantenimiento de Celebración
                    </h1>
                    <ol class="breadcrumb">
                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal" id="btnagregar"><i class="fa fa-copy"></i> Agregar Celebración</button>&nbsp;&nbsp;&nbsp;
                        <li><a href="#"><i class="fa fa-dashboard"></i> Menú Principal</a></li>
                        <li><a href="#">Mantenimientos</a></li>
                        <li class="active">Mantenimiento de Celebración</li>
                    </ol>
                </section>
                                                ...
                                                <div class="col-xs-12">
                                                    <p>
                                                        Nombre de la Celebración 
                                                               <input type="text" 
                                                                      name="txtNombreCelebracion" 
                                                                      id="txtNombreCelebracion" 
        ...
        <script src="js/mantenimiento.celebracion.js" type="text/javascript"></script>
