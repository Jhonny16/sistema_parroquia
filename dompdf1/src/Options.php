...
class Options
{
     ...
     * dompdf1's "chroot"
     *
     * Prevents dompdf1 from accessing system files or other files on the webserver.
     * All local files opened by dompdf1 must be in a subdirectory of this directory.
     * DO NOT set it to '/' since this could allow an attacker to use dompdf1 to
     * read any files on the server.  This should be an absolute path.
     *
     * ==== IMPORTANT ====
     * This setting may increase the risk of system exploit. Do not change
     * this settings without understanding the consequences. Additional
     * documentation is available on the dompdf1 wiki at:
     ...
     * system access available to dompdf1. Set this option to false (recommended)
     ...
     * allowing remote html code to be passed to $dompdf1 = new DOMPDF(); $dompdf1->load_html(...);
