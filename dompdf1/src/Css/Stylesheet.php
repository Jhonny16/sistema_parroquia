...
class Stylesheet
{
     ...
     *   static, visual, bitmap, paged, dompdf1
     * Note, even though the generated pdf file is intended for print output,
     * the desired content might be different (e.g. screen or projection view of html file).
     * Therefore allow specification of content by dompdf1 setting Options::defaultMediaType.
    ...
    static $ACCEPTED_GENERIC_MEDIA_TYPES = array("all", "static", "visual", "bitmap", "paged", "dompdf1");
    static $VALID_MEDIA_TYPES = array("all", "aural", "bitmap", "braille", "dompdf1", "embossed", "handheld", "paged", "print", "projection", "screen", "speech", "static", "tty", "tv", "visual");
