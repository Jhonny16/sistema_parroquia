...
{
    /**
     * Version string for dompdf1
     *
     * @var string
     */
    private $version = 'dompdf1';
    ...
    *
    * File extensions supported by dompdf1 for local files.
    *
    * @var array
    */
    ...
    public function __construct($options = null)
    {
        ...
        if (file_exists($versionFile) && ($version = file_get_contents($versionFile)) !== false && $version !== '$Format:<%h>$') {
          $this->version = sprintf('dompdf1 %s', $version);
        }
    ...
    public function render()
    {
        ...
        foreach ($metas as $meta) {
            ...
            if ($name === "dompdf1.view" && $this->parseDefaultView($value)) {
